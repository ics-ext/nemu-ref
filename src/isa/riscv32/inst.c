...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, s->dnpc = isa_raise_intr(0xb, s->pc)); // mcause[XLEN-1] = 0, mcause[XLEN-2:0] = 11
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, s->dnpc = CSRs(MEPC));
